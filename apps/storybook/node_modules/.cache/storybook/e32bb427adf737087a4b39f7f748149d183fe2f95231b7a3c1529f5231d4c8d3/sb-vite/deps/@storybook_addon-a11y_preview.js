...
// ../../node_modules/.pnpm/@storybook+addon-a11y@9.1.8_storybook@9.1.8_@testing-library+dom@10.4.1_vite@7.1.7_/node_modules/@storybook/addon-a11y/dist/preview.mjs
...
var run = async (input = DEFAULT_PARAMETERS, storyId) => {
  let axe = (await import("./axe-2JRMLH4D.js"))?.default || globalThis.axe, { config = {}, options = {} } = input;
    ...
    if (result) {
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await import("./matchers-7Z3WT2CE-5GPFANC5.js");
