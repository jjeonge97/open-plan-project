...
import {
  ...
  xr,
  yO
} from "./chunk-LPIQR4S2.js";
import {
  Xr,
  require_channels,
  require_client_logger
} from "./chunk-XRE2NPMW.js";
import {
  require_core_events
} from "./chunk-7ZSBYTHS.js";
import {
  require_preview_errors
} from "./chunk-TN2EJPKX.js";
import {
  require_preview_api
} from "./chunk-ZLWVYHQP.js";
import {
  require_react
} from "./chunk-MPA2ZOJT.js";
import {
  __toESM
} from "./chunk-7D4SUZUM.js";

// ../../node_modules/.pnpm/@storybook+addon-docs@9.1.8_@types+react@19.1.14_storybook@9.1.8_@testing-library+dom@10.4.1_vite@7.1.7_/node_modules/@storybook/addon-docs/dist/blocks.mjs
...
// ../../node_modules/.pnpm/storybook@9.1.8_@testing-library+dom@10.4.1_vite@7.1.7/node_modules/storybook/dist/docs-tools/index.js
  ...
  (function(n2, s2) {
    ...
    let pr = {
      ...
      JsdocTypeSymbol: r((e) => {
        ...
        return o2?.type === "JsdocTypeVariadic" && (o2.meta.position === "prefix" ? t2 = "..." : i2 = true, o2 = o2.element), o2?.type === "JsdocTypeName" ? t2 += o2.value : o2?.type === "JsdocTypeNumber" && (t2 += o2.value.toString()), i2 && (t2 += "..."), F2(`${e.value}(${t2})`);
      }, "JsdocTypeSymbol"),
...
var B = r((n2) => {
  ...
  switch (typeof a2 < "u" && (p2.raw = a2), n2.name) {
    ...
    case "signature":
      return { ...p2, ...Nr(n2) };
    case "union":
      return n2.elements?.every(Sr) ? { ...p2, name: "enum", value: n2.elements?.map(Er) } : { ...p2, name: s2, value: n2.elements?.map(B) };
    case "intersection":
      return { ...p2, name: s2, value: n2.elements?.map(B) };
    default:
...
var M = r((n2) => {
  ...
  switch (typeof a2 < "u" && (p2.raw = a2), n2.name) {
    ...
    case "union":
      ...
      } : c2 = { ...p2, name: s2, value: n2.elements?.map(M) }, c2;
    case "intersection":
      return { ...p2, name: s2, value: n2.elements?.map(M) };
    default:
      return { ...p2, name: "other", value: s2 };
  }
}, "convert");
...
function Be({ startLine: n2 = 0, fence: s2 = "```", spacing: a2 = "compact", markers: p2 = v, tokenizers: c2 = [
  ...
  return function(P2) {
    ...
    for (let de2 of ut(P2)) {
      ...
      if (q2 === null)
        continue;
      let S2 = m2(q2), z2 = S2.slice(1).map(T2);
      b2.push({
        description: g2(S2[0], p2),
        tags: z2,
        source: q2,
        problems: z2.reduce((Te2, ge2) => Te2.concat(ge2.problems), [])
      });
    }
    return b2;
  };
...
function Pt(n2, s2) {
  if (n2 != null) {
    let { value: a2 } = n2;
    if (!K(a2))
      return wt(a2) ? w(s2?.name, a2) : w(a2);
  }
  return null;
}
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", inline = false, ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-ENNDPBAP.js");
...
function Xe(n2 = "", i2 = {}) {
  function u2(e2, n3, ...r22) {
    ...
    })(e2, i2.overrides), t({}, n3, l2, { className: Qe(n3?.className, l2.className) || void 0 }), ...r22);
  }
  function Z2(e2) {
    e2 = e2.replace(w2, "");
    let t2 = false;
...
`, { inline: t2 }));
  ...
  i2.overrides = i2.overrides || {}, i2.sanitizer = i2.sanitizer || He, i2.slugify = i2.slugify || Le2, i2.namedCodesToUnicode = i2.namedCodesToUnicode ? t({}, o, i2.namedCodesToUnicode) : o, i2.createElement = i2.createElement || React21.createElement;
...
var index_modern_default = (t2) => {
  ...
  return React21.cloneElement(Xe(r22, i2), l2);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-AVL7NMMY-EUN2TBTA.js"));
...
//# sourceMappingURL=chunk-ABF3T7X4.js.map
